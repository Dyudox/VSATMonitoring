                    ...
                    <dx:ASPxGridView ID="grid_helpdesk" ClientInstanceName="grid_helpdesk" runat="server" DataSourceID="dstask" KeyFieldName="ID" Width="100%" AutoGenerateColumns="false" 
                        ...
                        <Columns>
                            ...
                            <dx:GridViewDataTextColumn Caption="No. Pengaduan" PropertiesTextEdit-ReadOnlyStyle-BackColor="#c0c0c0" ReadOnly="true" 
                                PropertiesTextEdit-DisplayFormatInEditMode="true" Width="100%" PropertiesTextEdit-DisplayFormatString="Auto Increment" 
                                HeaderStyle-HorizontalAlign="Center" CellStyle-HorizontalAlign="Center" FieldName="NomorPengaduan" 
                    ...
                    <dx:ASPxGridView ID="grid_koordinator" ClientInstanceName="grid_koordinator" runat="server" DataSourceID="dstaskcoor" KeyFieldName="ID" Width="100%" 
                        ...
                        <Columns>
                            ...
                            <dx:GridViewDataTextColumn FieldName="NamaTask1" Width="100%">
                                ...
                                <PropertiesTextEdit ValidationSettings-RequiredField-IsRequired="false"></PropertiesTextEdit>
                            ...
                            <dx:GridViewDataDateColumn FieldName="TglSelesai" Visible="false" Caption="Tanggal Mulai" Width="100%">
                                ...
                                <PropertiesDateEdit DisplayFormatString="dd/MM/yyyy" DisplayFormatInEditMode="True" ValidationSettings-RequiredField-IsRequired="false"></PropertiesDateEdit>
                            </dx:GridViewDataDateColumn>
                            <dx:GridViewDataComboBoxColumn FieldName="IdProvinsi" Visible="false" Width="100%">
                            ...
                            <dx:GridViewDataMemoColumn FieldName="CatatanKoordinator" Visible="true" HeaderStyle-Wrap="True" Width="100%">
                                ...
                                <Settings AutoFilterCondition="Contains"></Settings>
								<PropertiesMemoEdit ValidationSettings-RequiredField-IsRequired="false" Width="300px" Height="90px"></PropertiesMemoEdit>
								<HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                            </dx:GridViewDataMemoColumn>
                ...
                <div class="panel-body">
                    <dx:ASPxGridView ID="grid_manager" runat="server" DataSourceID="dsmanager" KeyFieldName="ID" Width="100%" AutoGenerateColumns="false" 
                        ...
                        <Columns>
                            ...
                            <dx:GridViewDataTextColumn FieldName="NamaTask" Caption="Nama Task" Width="200px" VisibleIndex="2">
                                <%--<DataItemTemplate>
                                    <%# Eval("NamaTask")%> - <%# Eval("IdProvinsi")%>
                                    <%# If(Eval("NamaTask").ToString() <> "", Eval("NamaTask") + " - " + Eval("IdProvinsi"), "") %>
                                </DataItemTemplate>--%>
        ...
        function OnEndCallback(s, e) {
            if (s.cpMessageError) {
                Swal.fire({
                    icon: 'error',
                    title: 'Error',
                    text: s.cpMessageError
                });
                s.cpMessageError = null; // reset biar nggak muncul lagi
            }

            if (s.cpMessageSuccess) {
                Swal.fire({
                    icon: 'success',
                    title: 'Berhasil',
                    text: s.cpMessageSuccess
                });
                s.cpMessageSuccess = null;
            }
        }
    </script>
</asp:Content>
