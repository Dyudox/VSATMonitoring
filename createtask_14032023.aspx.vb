...
Partial Class createtask
    ...
    Protected Sub Page_Load(sender As Object, e As EventArgs) Handles Me.Load
        If Session("username") = "admin" Then
            ...
            dsmanager.SelectCommand = "SELECT a.ID, a.NoTask, a.NomorPengaduan, a.TanggalTask, a.NamaTask as NamaTask1, a.IdKoordinator,a.NamaKoordinator, " &
                                        "a.CatatanManager,a.IdStatusKoordinator, a.IdStatusManager, a.NamaTeknisi, a.IdJenisTask, a.TglMulai, a.TglSelesai, " &
        ...
        If Session("Level") = "Coordinator" Then
            ...
            dstaskcoor.SelectCommand = "SELECT a.ID, a.NoTask, a.NomorPengaduan, a.TanggalTask, a.NamaTask as NamaTask1, a.IdKoordinator,a.NamaKoordinator, " &
