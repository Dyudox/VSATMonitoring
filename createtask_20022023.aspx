    ...
    <div class="padding-md">
        <div class="row">
            <div class="panel panel-default" id="panelhelpdesk" runat="server">
                ...
                <div class="panel-body">
                    <dx:ASPxGridView ID="grid_helpdesk" ClientInstanceName="grid_helpdesk" runat="server" DataSourceID="dstask" KeyFieldName="ID" Width="100%" AutoGenerateColumns="false" 
                        ...
                        <Columns>
                            <dx:GridViewCommandColumn FixedStyle="Left" CellStyle-BackColor="#d6f1ff" HeaderStyle-BackColor="#d6f1ff" ShowDeleteButton="True" ShowEditButton="True" ShowNewButtonInHeader="True" VisibleIndex="10">
                    ...
                    <asp:SqlDataSource ID="dstask" runat="server" ConnectionString="<%$ ConnectionStrings:dbVsatConnectionString %>" SelectCommand="SELECT a.NoTask,a.ID, a.NomorPengaduan, a.TanggalTask, a.LaporanPengaduan, a.IdStatusTask, a.TglStatusTask, a.IdProject, a.AsalPengaduan, a.NamaPelapor, a.TelpPelapor, a.AlamatPengaduan, a.DeskripsiPermasalahan, a.City as IdCity, a.Provinsi as IdProvinsi, a.CatatanKoordinator FROM  trTask a  where NomorPengaduan <> '' order by ID DESC"></asp:SqlDataSource>
            ...
            <div class="panel panel-default" id="panelkoordinator" runat="server">
                ...
                <div class="panel-body">
                    <dx:ASPxGridView ID="grid_koordinator" ClientInstanceName="grid_koordinator" runat="server" DataSourceID="dstaskcoor" KeyFieldName="ID" Width="100%" AutoGenerateColumns="false" Theme="MetropolisBlue" OnCellEditorInitialize="grid_koordinator_CellEditorInitialize" OnBeforePerformDataSelect="grid_koordinator_BeforePerformDataSelect">
                        <Settings HorizontalScrollBarMode="Auto" ShowFooter="false" ShowGroupPanel="True" />
                        <SettingsBehavior ConfirmDelete="True" />
                        <SettingsResizing ColumnResizeMode="Control" Visualization="Postponed" />
                        <SettingsPager>
                        ...
                        <Columns>
                            <dx:GridViewCommandColumn FixedStyle="Left" CellStyle-BackColor="#d6f1ff" HeaderStyle-BackColor="#d6f1ff" ShowDeleteButton="True" ShowEditButton="True" ShowNewButtonInHeader="True" VisibleIndex="30">
                                <CellStyle BackColor="#d6f1ff">
                                </CellStyle>
                            </dx:GridViewCommandColumn>
            ...
            <div class="panel panel-default" id="panelmanager" runat="server">
                ...
                <div class="panel-body">
                    <dx:ASPxGridView ID="grid_manager" runat="server" DataSourceID="dsmanager" KeyFieldName="ID" Width="100%" AutoGenerateColumns="false" 
                        ...
                        <SettingsDetail ShowDetailRow="true" />
                        <Columns>
                            <dx:GridViewCommandColumn FixedStyle="Left" HeaderStyle-HorizontalAlign="Center" CellStyle-BackColor="#d6f1ff" HeaderStyle-BackColor="#d6f1ff" ShowDeleteButton="True" ShowEditButton="True" VisibleIndex="20">
                                <CellStyle BackColor="#d6f1ff">
                                </CellStyle>
                            </dx:GridViewCommandColumn>
                            ...
                            <dx:GridViewDataComboBoxColumn FieldName="NamaTeknisi" Width="150px" Caption="Teknisi" VisibleIndex="3">
                                ...
                                <PropertiesComboBox DataSourceID="dsteknisi" TextField="Nama"
