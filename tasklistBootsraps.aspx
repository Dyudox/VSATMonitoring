...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <div class="padding-md">
        <div id="bucketTask" runat="server">
            <div id="bucket1" runat="server" class="row">
            ...
            <div id="bucket2" runat="server" class="row">
                <div class="col-md-3 col-sm-4">
            ...
            <div id="divSPD" runat="server" class="row">
                <div class="col-md-3 col-sm-4">
                    <a href="tasklistBootsraps.aspx?page=dattsklis&status=PermintaanSPD" data-toggle="modal" id="PermintaanSPD" runat="server">
                        <div class="panel panel-default panel-stat2 bg-success">
                            <div class="panel-body">
                                <span class="stat-icon">
                                ...
                                <div class="pull-right text-right">
                                    <div class="value">
                                        <asp:Label ID="txtPermintaanSPD" runat="server" Font-Size="XX-Large" ForeColor="White">0</asp:Label>
                                    </div>
                                    <div class="title">
                                        <asp:Label ID="Label6" runat="server" ForeColor="White" Text="Permintaan SPD"></asp:Label>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-md-3 col-sm-4">
                    <a href="tasklistBootsraps.aspx?page=dattsklis&status=PendingSPD" data-toggle="modal" id="PendingSPD" runat="server">
                        <div class="panel panel-default panel-stat2 bg-info">
                            <div class="panel-body">
                                <span class="stat-icon">
                                ...
                                <div class="pull-right text-right">
                                    <div class="value">
                                        <asp:Label ID="txtPendingSPD" runat="server" Font-Size="XX-Large" ForeColor="White">0</asp:Label>
                                    </div>
                                    <div class="title">
                                        <asp:Label ID="Label10" runat="server" ForeColor="White" Text="Pending SPD"></asp:Label>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-md-3 col-sm-4">
                    <a href="tasklistBootsraps.aspx?page=dattsklis&status=DoneSPD" data-toggle="modal" id="DoneSPD" runat="server">
                        <div class="panel panel-default panel-stat2 bg-warning">
                            <div class="panel-body">
                                <span class="stat-icon">
                                    <i class="fa fa-shopping-cart"></i>
                                ...
                                <div class="pull-right text-right">
                                    <div class="value">
                                        <asp:Label ID="txtDoneSPD" runat="server" Font-Size="XX-Large" ForeColor="White">0</asp:Label>
                                    </div>
                                    <div class="title">
                                        <asp:Label ID="Label13" runat="server" ForeColor="White" Text="Done SPD"></asp:Label>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <%--<div class="col-md-3 col-sm-4">
                    <a href="tasklistBootsraps.aspx?page=dattsklis&status=all" data-toggle="modal" id="A11" runat="server">
                        <div class="panel panel-default panel-stat2 bg-danger">
                            <div class="panel-body">
                                <span class="stat-icon">
                                    <i class="fa fa-envelope"></i>
                                ...
                                <div class="pull-right text-right">
                                    <div class="value">
                                        <asp:Label ID="Label14" runat="server" Font-Size="XX-Large" ForeColor="White"></asp:Label>
                                    </div>
                                    <div class="title">
                                        <asp:Label ID="label15" runat="server" ForeColor="White" Text="All Data"></asp:Label>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div id="taskGrid" runat="server" class="row">
            ...
            <div id="taskGridSPD" runat="server" class="row">
                <div class="panel-body" style="overflow-x: auto">
                    <dx:ASPxGridView ID="gridSPD" ClientInstanceName="gridSPD" runat="server" DataSourceID="dsTaskSPD" KeyFieldName="ID" Width="100%" AutoGenerateColumns="false" Theme="MetropolisBlue">
                        <Settings ShowFooter="false" ShowGroupPanel="True" />
                        ...
                        <Columns>
                            <dx:GridViewDataTextColumn Caption="#" HeaderStyle-HorizontalAlign="Center" VisibleIndex="1" Width="30px">
                                <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                                <DataItemTemplate>
                                    <a href="formadminpantauspd.aspx?ID=<%# Eval("ID")%>&VID=<%# Eval("VID")%>&notask=<%# Eval("NoTask")%>&NoReferensi=<%# Eval("NoReferensi")%>&status=<%# Eval("statustrf")%>">
                                        <asp:Image ID="Image1" runat="server" ImageUrl="~/img/Apps-text-editor-icon22.png" Width="20px"/>
                                    </a>
                                </DataItemTemplate>
                            </dx:GridViewDataTextColumn>
                            <dx:GridViewDataTextColumn Caption="No. BPS" HeaderStyle-HorizontalAlign="Center" VisibleIndex="1" FieldName="NoReferensi" Visible="true">                              
                                <HeaderStyle HorizontalAlign="Center"></HeaderStyle>                          
                            </dx:GridViewDataTextColumn>
                            <dx:GridViewDataTextColumn Caption="VID" FieldName="VID" HeaderStyle-HorizontalAlign="Center" Width="200px" VisibleIndex="2" Visible="false">
                                <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                                <%--<DataItemTemplate>
                                    <a href="createdetiltask.aspx?ID=<%# Eval("ID")%>&VID=<%# Eval("VID")%>&notask=<%# Eval("NoTask")%>"><%# Eval("VID")%></a>
                                </DataItemTemplate>--%>
                            </dx:GridViewDataTextColumn>
                            <dx:GridViewDataDateColumn Caption="Tanggal Transfer" PropertiesDateEdit-DisplayFormatString="yyyy-MM-dd HH:mm:ss" Width="150px" HeaderStyle-HorizontalAlign="Center" FieldName="tgltrf" VisibleIndex="3">
                                <PropertiesDateEdit DisplayFormatString="yyyy-MM-dd HH:mm:ss"></PropertiesDateEdit>
                                <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                            </dx:GridViewDataDateColumn>
                            <dx:GridViewDataTextColumn Caption="Nominal Transfer" HeaderStyle-HorizontalAlign="Center" FieldName="Nominal" Width="150px" VisibleIndex="4">
                                <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                            </dx:GridViewDataTextColumn>
                            <dx:GridViewDataTextColumn Caption="Approve Nominal" HeaderStyle-HorizontalAlign="Center" FieldName="ApprovalNominal" Width="150px" VisibleIndex="4">
                                <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                            </dx:GridViewDataTextColumn>
                            <dx:GridViewDataTextColumn Caption="Jenis Biaya" HeaderStyle-HorizontalAlign="Center" FieldName="JenisBiaya" Width="100px" VisibleIndex="5">
                                <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                            </dx:GridViewDataTextColumn>
                            <dx:GridViewDataTextColumn Caption="Notes Finance" HeaderStyle-HorizontalAlign="Center" FieldName="notekeuangan" Width="150px" VisibleIndex="6">
                                <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                            </dx:GridViewDataTextColumn>
                            <dx:GridViewDataTextColumn Caption="Teknisi" HeaderStyle-HorizontalAlign="Center" FieldName="NamaTeknisi" Width="150px" VisibleIndex="7">
                                <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                            </dx:GridViewDataTextColumn>
                            <dx:GridViewDataTextColumn Caption="Status" HeaderStyle-HorizontalAlign="Center" FieldName="Status" Width="100px" VisibleIndex="8">
                                <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                            </dx:GridViewDataTextColumn>
                        </Columns>
                    </dx:ASPxGridView>
                    <asp:SqlDataSource ID="dsTaskSPD" runat="server" ConnectionString="<%$ ConnectionStrings:dbVsatConnectionString %>"></asp:SqlDataSource>
                </div>
            </div>
